...
Generated 2026-09-14 by `scripts/rank.mjs` from `data/*.jsonl` at commit `ba1c77f` of [PeerInfinity/tmt-fork-census](https://github.com/PeerInfinity/tmt-fork-census). Every number below is read from those rows.
