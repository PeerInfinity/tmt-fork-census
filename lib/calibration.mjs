// The three calibration rows (local clones, not forks) — shared by stage 3 and rank. Paths resolve under CC_DIR
...
export const CALIBRATION = [
  ...
  { full_name: 'calibration:upgrade-land-tmt', short: 'upgrade-land-tmt', local: path.join(CC_DIR, 'upgrade-land-tmt'), upstream: null },
];
